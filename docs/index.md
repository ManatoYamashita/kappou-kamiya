...
- **[Design System](./styling/design-system.md)** ⭐ 最新更新
  - デザインコンセプト（侘寂、余白の美、伝統と革新の融合、四季の感覚）
  - カラーパレット（Paper, Ink, Accent）と色彩哲学
  - タイポグラフィ（Shippori Mincho + Noto Serif JPフォールバック）
  - スペーシング、レイアウト、グリッドシステム
  - ボタン（グラデーションアニメーション）、カード、アニメーション
  - 和風デザイン要素（和紙テクスチャ、縦書き、セパレーター、家紋風マーク）
  - レスポンシブデザイン、アクセシビリティ、ベストプラクティス
...
- **[Branching Rules](./development/branching.md)**
  - ブランチ戦略、禁止事項、CIとPRフロー
...
- **開発環境:** .nvmrcファイル追加、package.jsonにenginesフィールド追加
- **ドキュメント:** Getting Startedにセキュリティ注意事項とnvm使用方法を追加
- タイポグラフィを現行仕様に更新（Shippori Mincho + Noto Serif JP）
- ボタンコンポーネントのグラデーションアニメーション仕様を追記
- 和風デザイン要素の詳細説明を追加
- カラーパレットの心理効果と用途を明確化
